        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="flex-1 space-y-6 text-center lg:text-start">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-base-content tracking-tight leading-[1.15]">
              {locale === "ar" ? (
                ...
                <>
                  <span className="text-primary">Studying</span> Online is now{" "}
          ...
          <div className="flex-1 relative w-full max-w-md lg:max-w-none flex justify-center">
            <div className="relative">
              ...
              <div
                className="absolute -left-12 top-[20%] bg-white/95 dark:bg-base-100 backdrop-blur-md p-3.5 rounded-2xl shadow-xl border border-base-200/50 flex items-center gap-3 animate-bounce"
              ...
              <div className="absolute left-4 -bottom-6 bg-white/95 dark:bg-base-100 backdrop-blur-md p-3 rounded-2xl shadow-xl border border-base-200/50 flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-[11px] font-extrabold text-base-content">
                    {t("badgeQuery")}
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          {[
            ...
            <div key={i} className="space-y-1">
              ...
              <div className="text-xs sm:text-sm text-base-content/70 font-semibold">
                {stat.label}
              </div>
            </div>
          ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={i}
                className="card bg-base-100 hover:shadow-2xl transition-all duration-300 border border-base-300/60 p-8 text-center rounded-2xl"
              >
        ...
        {filteredCourses.length > 0 ? (
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {filteredCourses.map((course) => (
              <div
                key={course.id}
                className="card bg-base-100 border border-base-300 hover:shadow-2xl transition-all duration-300 rounded-2xl overflow-hidden flex flex-col"
              >
                {/* Thumbnail */}
                ...
                <div className="p-5 flex-grow flex flex-col justify-between space-y-4">
                  <div className="space-y-2">
                    <h3 className="font-extrabold text-base-content line-clamp-1 leading-snug">
                      {course.title}
                    </h3>
