                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div
                        className={`w-6 h-6 rounded-full shrink-0 flex items-center justify-center text-xs font-bold ${isActive ? "bg-primary text-primary-content animate-pulse" : "bg-base-300 text-base-content/60"}`}
                      >
                        {index + 1}
                      </div>
                      ...
                      {[5, 4, 3, 2, 1].map((stars) => {
                        ...
                        return (
                          <div key={stars} className="flex items-center gap-3">
                            ...
                            <span className="w-8 text-base-content/50 text-start">
                              {count}
                            </span>
                          </div>
                        );
